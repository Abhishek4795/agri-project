...
const Projects = () => {
  ...
  return (
    <main className="min-h-screen bg-[#f1f5f2] pb-32">
      {/* Sleek Minimalist Hero */}
      <header className="pt-40 pb-20 px-6 lg:px-16 text-center max-w-4xl mx-auto">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6" aria-label="Our Projects">
        
        {/* Feature Large Card 1 */}
        <article className={`col-span-1 md:col-span-2 lg:col-span-8 rounded-3xl ${projects[0].bg} p-10 lg:p-14 text-white relative overflow-hidden group min-h-[400px] flex flex-col justify-end`}>
        ...
        {/* Tall Card 2 */}
        <article className={`col-span-1 md:col-span-1 lg:col-span-4 rounded-3xl ${projects[1].bg} p-10 text-white relative overflow-hidden group min-h-[400px] flex flex-col`}>
        ...
        {/* Card 3 */}
        <article className={`col-span-1 md:col-span-1 lg:col-span-4 rounded-3xl ${projects[2].bg} p-8 text-white relative overflow-hidden group min-h-[300px] flex flex-col justify-end`}>
        ...
        {/* Card 4 */}
        <article className={`col-span-1 md:col-span-1 lg:col-span-4 rounded-3xl ${projects[3].bg} p-8 text-white relative overflow-hidden group min-h-[300px] flex flex-col justify-end`}>
        ...
        {/* Card 5 */}
        <article className={`col-span-1 md:col-span-2 lg:col-span-4 rounded-3xl ${projects[4].bg} p-8 text-white relative overflow-hidden group min-h-[300px] flex items-center justify-center text-center`}>
